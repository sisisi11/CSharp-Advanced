...
namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnauthorizedAccessExceptionMessage =
            "The folder/file you are trying to access needs a higher level of rights than you currently have.";
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "The given directory is too high to reach.";
        ...
        public const string InvalidTakeQuantityParamater = "The take quantity you have given is invalid!";
    }
}
